...
public class NormelModel extends Model {
        ...
        public void takeFromDatabaseHotelRooms(String query) {
                ...
                HotelRooms.add(new StandardRoom("Beachside Resort", "Miami", "456 Ocean Dr", "HR002", false, "Deluxe",
                                300.00));
                HotelRooms.add(
                                new StandardRoom("Mountain Retreat", "Denver", "789 Alpine Rd", "HR003", true,
                                                "Standard", 180.00));
                HotelRooms
                                .add(new StandardRoom("City Inn", "Chicago", "1010 Lakeshore Blvd", "HR004", true,
                                                "Economy", 120.00));
                HotelRooms.add(new StandardRoom("Royal Palace", "Los Angeles", "1111 Sunset Blvd", "HR005", false,
                                "Presidential Suite", 1000.00));
                HotelRooms.add(new StandardRoom("Urban Stay", "San Francisco", "1212 Market St", "HR006", true,
                                "Family Room",
                                400.00));
                HotelRooms.add(
                                new StandardRoom("Luxury Suites", "Las Vegas", "1313 Strip Ave", "HR007", true,
                                                "Penthouse", 800.00));
        ...
        public void takeFromHotelProvider() {
                ...
                HotelRooms.add(new StandardRoom("Skyline Inn", "Dallas", "345 Elm Ave", "HR012", false, "Deluxe",
                                320.00));
                HotelRooms.add(
                                new StandardRoom("Harbor Stay", "San Diego", "567 Shoreline Blvd", "HR013", true,
                                                "Standard", 190.00));
                ...
                HotelRooms.add(
                                new StandardRoom("Seaside Escape", "Honolulu", "111 Beach Ln", "HR016", true,
                                                "Family Room", 450.00));
                HotelRooms.add(
                                new StandardRoom("Summit View", "Salt Lake City", "131 Peak Rd", "HR017", true,
                                                "Penthouse", 850.00));
                ...
                HotelRooms.add(new StandardRoom("Urban Retreat", "Atlanta", "151 Peach St", "HR019", true, "Double",
                                210.00));
                HotelRooms
                                .add(new StandardRoom("Rustic Cabin", "Nashville", "161 Forest Ln", "HR020", true,
                                                "Cottage", 280.00));
        }
